# ComplyCloud fork of Twemoji

This is forked in order to host our own copy of the emoji library and not rely on an external pdf.

These emojis are used for rendering emojis in PDF exports generated by Cirrus front-end
